...
function MaintenancePlanManagementPage() {
  ...
  const filteredPlans = useMemo(() => {
    return (maintenancePlanList || []).filter((plan) => {
      const keyword = search.trim().toLowerCase();
  ...
  }, [maintenancePlanList, search, filterStatus, filterTechnician]);
  ...
  if (!currentUser) {
    return <div className="p-4 text-slate-500">Đang tải thông tin người dùng...</div>;
  }
